...
<div class="untree_co-section refund-guarantee" id="refund-section">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <!-- Header -->
        <div class="row">
          <div class="col-12 text-center mb-5" data-aos="fade-up" data-aos-delay="0">
            <div class="refund-icon mb-4">
              <svg xmlns="http://www.w3.org/2000/svg"  width="80" height="80"  fill="none" viewBox="0 0 24 24" stroke-width="1.5" :stroke="themeColorOrange" class="size-6">
